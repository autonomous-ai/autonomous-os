...
func (s *PicoclawService) StartSkillWatcher(ctx context.Context) (runtimeErr error) {
...
func (s *PicoclawService) downloadSkills() []string {
...
func (s *PicoclawService) downloadSkillsByNameResult(names []string) skillDownloadResult {
