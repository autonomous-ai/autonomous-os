...
# Stubs for unpickling checkpoint saved from POSTER_V2/main.py
class RecorderMeter:
    def __init__(self, total_epoch=1):
...
def to_query(x, N, num_heads, dim_head):
    B = x.shape[0]
