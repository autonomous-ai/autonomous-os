...
FIRE_HAZARD_ENABLED = os.environ.get("LELAMP_FIRE_HAZARD_ENABLED", "true").lower() == "true"
FIRE_HAZARD_CHECK_INTERVAL_S = float(os.environ.get("LELAMP_FIRE_HAZARD_CHECK_INTERVAL_S", "0"))
...
FIRE_HAZARD_CONFIRM_S = float(os.environ.get("LELAMP_FIRE_HAZARD_CONFIRM_S", "10.0"))
FIRE_HAZARD_DEDUP_WINDOW_S = float(os.environ.get("LELAMP_FIRE_HAZARD_DEDUP_WINDOW_S", "120.0"))
