...
const (
	...
	// CharacteristicSecureReadPermission requires LE Secure Connections
	// pairing before the value can be read. Maps to BlueZ "secure-read".
	CharacteristicSecureReadPermission
	// CharacteristicSecureWritePermission requires LE Secure Connections
	// pairing before the value can be written. Maps to BlueZ "secure-write".
