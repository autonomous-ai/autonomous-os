...
trực tiếp. **Mặc định chưa bật chọn skill.** Onboarding giữ nguyên cấu hình
OpenClaw của người dùng, không tự bật tính năng này.

Để bật, ghép entry sau vào `openclaw.json`, rồi khởi động lại gateway OpenClaw
qua luồng quản lý runtime thông thường:
