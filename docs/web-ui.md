...
The sidebar groups Monitor and Settings leaves; the primary Monitor leaves include:
...
computer integrations separate from the device-status cards on Overview.
