...
| Add a voice — STT, TTS, or a realtime provider | a subclass in `hal/drivers/voice/` or `hal/realtime/voice_agent/` | [`voice_agent/openai_realtime.py`](hal/realtime/voice_agent/openai_realtime.py) |
