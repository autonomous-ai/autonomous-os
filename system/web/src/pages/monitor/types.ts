...
export const NAV: NavEntry[] = [
  { id: "chat",     label: "Chat",     icon: "▤" },
  {
    ...
    children: [
      ...
      { id: "settings:spotify",  label: "Spotify",   icon: "♪" },
