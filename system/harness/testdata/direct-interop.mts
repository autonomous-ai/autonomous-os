    ...
    try {
        ...
        switch (req.url) {
            ...
            case '/question':
                ...
                break;
            case '/state':
                out = { submits, answers, pairs: backend.listPairs(), backend: backend.isConnected(), commander: backend.autonomousDeviceConnected() };
                break;
