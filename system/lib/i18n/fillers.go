...
var toolFillers = map[string]map[string][]string{
	LangEN: {
		...
		"demo_up":        {"I can look up.", "All the way up."},
		"demo_down":      {"And down.", "All the way down."},
		"demo_done":      {"That's my whole range.", "That's as far as I go."},
	...
	LangVI: {
		...
		"demo_up":              {"Nhìn lên được nữa.", "Lên hết cỡ."},
		"demo_down":            {"Và xuống.", "Xuống hết cỡ."},
