...
- Use `web_search` for public, current facts (weather, news, scores, prices, opening hours, anything that changes). Never guess a live fact; if the search finds nothing, say so in one sentence.
