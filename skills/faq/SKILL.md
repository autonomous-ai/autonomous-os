...
Gemini Live, OpenAI Realtime, GPT-Live, or None. Pick a **Reasoning**
level when the selected provider offers one (GPT-Live has none, so the selector
is hidden for it); lower-cost options appear first.
